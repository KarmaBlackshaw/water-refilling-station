...
export { default as BaseFullPageTabs } from './BaseFullPageTabs.vue';
export { default as BaseFullPageTabsHeader } from './BaseFullPageTabsHeader.vue';
...
export { default as BaseTableFilterBar } from './BaseTableFilterBar.vue';
