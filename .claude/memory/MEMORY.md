...
- [Area/rider model](area-rider-model.md) — area = named delivery zone owning a rider; active rider = coverage record overrides `primary_rider_id` (date-windowed), via `getActiveRiderForArea`.
